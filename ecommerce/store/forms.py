...
class UpdatePasswordForm(SetPasswordForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields[
            'new_password1'].help_text = '<ul class="form-text text-muted small"><li>Your password can\'t contain your personal information.</li><li>Your password must contain at least 8 characters.</li><li>Your password can\'t be a commonly used password.</li><li>Your password should have at least 1 special symbol, at least 1 numeric value, at least 1 upper-case letter.</li></ul>'
...
class SignUpForm(UserCreationForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['password1'].label = 'Your New Password'
        self.fields[
        ...
        self.fields['password2'].label = 'Confirm Your New Password'
        self.fields[
